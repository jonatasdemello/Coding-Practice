...
namespace CodingTest
{
    ...
    /// https://msdn.microsoft.com/en-us/library/bb669096(v=vs.110).aspx
    /// </summary>
    ...
    public class ObjectShredder<T>
    {
        ...
        public DataTable ExtendTable(DataTable table, Type type)
        {
            ...
            foreach (PropertyInfo p in type.GetProperties())
            {
                ...
                var dc = table.Columns.Contains(p.Name) ? table.Columns[p.Name] : table.Columns.Add(p.Name, colType); //  p.PropertyType
                //
                // The preceding example assumes that the properties of the DataColumn are not nullable types. 
                // To handle properties with nullable types, use the following code:
                //
